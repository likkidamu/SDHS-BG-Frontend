...
import { AlertBox, StatCard, StatusBadge, TopNavbar } from '../components';
...
const styles = StyleSheet.create({
  ...
  volunteerCard: { backgroundColor: colors.card, borderRadius: borderRadius.lg, padding: spacing.md, borderWidth: 1, borderColor: colors.borderLight, ...shadows.card }, cardHeader: { flexDirection: 'row', alignItems: 'flex-start', gap: spacing.sm }, identity: { flex: 1 }, name: { fontSize: 15, color: colors.textDark, ...fonts.semiBold }, vid: { fontSize: 12, color: colors.textMuted, marginTop: 2 }, meta: { fontSize: 12, color: colors.textBody, marginTop: 2 }, contact: { marginTop: spacing.sm, gap: 2 }, contactText: { fontSize: 12, color: colors.textBody }, reason: { fontSize: 12, color: colors.warningText, marginTop: 6 }, rowActions: { flexDirection: 'row', gap: spacing.sm, marginTop: 10 }, smallButton: { minHeight: 44, justifyContent: 'center', paddingHorizontal: spacing.smd, paddingVertical: spacing.sm, borderRadius: borderRadius.sm }, manageButton: { backgroundColor: colors.navy }, analyticsButton: { backgroundColor: colors.blue }, smallButtonText: { color: colors.white, fontSize: 12, ...fonts.semiBold },
  modalOverlay: { flex: 1, backgroundColor: colors.overlay, justifyContent: 'flex-end' }, modalBox: { backgroundColor: colors.surface, borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: spacing.lg, maxHeight: '92%' }, modalTitle: { fontSize: 18, color: colors.textDark, ...fonts.bold }, modalName: { fontSize: 16, color: colors.navy, ...fonts.semiBold, marginTop: 4 }, modalMeta: { fontSize: 12, color: colors.textMuted, marginBottom: spacing.md }, fieldRow: { marginBottom: 12 }, fieldLabel: { fontSize: 12, color: colors.textMuted, marginBottom: 4, marginTop: 4, ...fonts.medium }, fieldInput: { borderWidth: 1, borderColor: colors.borderLight, borderRadius: borderRadius.md, padding: spacing.sm, fontSize: 14, backgroundColor: colors.input }, fieldInputError: { borderColor: colors.errorText }, fieldError: { color: colors.errorText, fontSize: 11, marginTop: 3 }, segmentRow: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.sm, marginBottom: 12 }, segment: { minHeight: 44, justifyContent: 'center', paddingHorizontal: 12, paddingVertical: 7, borderRadius: borderRadius.sm, borderWidth: 1, borderColor: colors.borderLight }, segmentActive: { backgroundColor: colors.navy, borderColor: colors.navy }, segmentText: { fontSize: 12, color: colors.textBody }, segmentTextActive: { color: colors.white, ...fonts.semiBold }, switchRow: { minHeight: 44, flexDirection: 'row', alignItems: 'center', gap: spacing.sm }, switchLabel: { color: colors.textBody, ...fonts.semiBold }, dangerZone: { borderTopWidth: 1, borderTopColor: colors.errorBorder, marginTop: spacing.lg, paddingTop: spacing.md }, dangerTitle: { color: colors.maroon, fontSize: 15, ...fonts.bold, marginBottom: spacing.sm }, modalActions: { flexDirection: 'row', gap: spacing.sm, marginTop: spacing.lg }, modalButton: { minHeight: 44, flex: 1, padding: 14, borderRadius: borderRadius.md, alignItems: 'center', justifyContent: 'center' }, saveButton: { backgroundColor: colors.navy }, confirmOverlay: { flex: 1, backgroundColor: colors.overlay, justifyContent: 'center', padding: spacing.xl }, confirmBox: { backgroundColor: colors.surface, borderRadius: borderRadius.xl, padding: spacing.lg }, confirmText: { color: colors.textBody, fontSize: 14, lineHeight: 20, marginTop: spacing.md },
});
